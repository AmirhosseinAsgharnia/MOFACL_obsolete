function Output=fuzzy_engine_3(input , params)
%% Mapping inside the boundary

N = params.input_number;
rule = params.weights;
MF_num = params.membership_fun_number;
bound = params.input_bounds;
